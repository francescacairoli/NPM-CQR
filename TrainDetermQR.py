...
class TrainDetermQR():
	...
	def __init__(self, model_name, dataset, idx = None, opt = "Adam", n_hidden = 50, xavier_flag = False):
	...
	def train(self, n_epochs, batch_size, lr):
		...
		Xt_val = Variable(FloatTensor(self.dataset.X_cal[:self.valid_set_dim_size]))
		Tt_val = Variable(FloatTensor(self.dataset.R_cal[:self.valid_set_dim]))
